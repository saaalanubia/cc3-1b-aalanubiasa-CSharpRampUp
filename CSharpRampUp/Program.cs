namespace CSharpRampUp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"In Greece, there once were four heroes summoned to Mount Olympus. They were  {character1}, {character2}, {character3}, {character4}, and {character5}.");
            ...
            Console.WriteLine($"also, each hero possessed a special item or ability. {character1} had the extraordinary power of {item1}, {character2} could manipulate the elements with {item2}, {character3} could teleport instantly using {item3}, {character4} could read minds with {item4}, and {character5} could control time itself with {item5}.");
            Console.WriteLine($"Mount Olympus was under a dark threat from an ancient evil that lurked in the underworld. The heroes, united , set out on a perilous journey to uncover the source of the darkness and vanquish it.");
            ...
            Console.WriteLine($"As they reached the heart of the vortex, a formidable foe, a dragon named Drogon, awaited them. With a combination of their unique abilities and the strength of their {equipment1}, {equipment2}, {equipment3}, {equipment4}, and {equipment5}, the heroes engaged in an epic battle.");
            Console.WriteLine($"The clash between the heroes and Drogon shook the very foundations of Mount Olympus. In the end, the heroes emerged victorious, banishing the darkness and restoring peace to the land and to the gods.");
            Console.WriteLine($"The entirety of Greece celebrated the bravery of {character1}, {character2}, {character3}, {character4}, and {character5}, and their names were etched into the annals of history as legendary heroes who saved the realm from impending doom.");
